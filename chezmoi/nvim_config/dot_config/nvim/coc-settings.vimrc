...
" Github neoclide/coc.nvim/wiki/Completion-with-sources
...
" inoremap <expr> <cr> coc#pum#visible() ? coc#pum#confirm() : "\<S-CR>"
...
xmap cic <Plug>(coc-classobj-i)
omap cic <Plug>(coc-classobj-i)
xmap cac <Plug>(coc-classobj-a)
omap cac <Plug>(coc-classobj-a)
